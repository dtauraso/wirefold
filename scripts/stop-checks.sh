...
for chk in check-trace-kind-parity check-no-ts-timers check-message-kind-parity check-slot-phase-boundary check-generated check-no-camera-roundtrip check-polar-only-nav; do
