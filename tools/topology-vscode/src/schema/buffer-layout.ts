...
export const OVERLAY_COL_LAST_ABC_DRAG_NODE_ROW  = 12; // u32
...
export function readOverlayLastAbcDragNodeRow(view: DataView): number { return view.getUint32(OVERLAY_COL_LAST_ABC_DRAG_NODE_ROW, true); }
