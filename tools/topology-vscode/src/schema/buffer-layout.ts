...
export const BUF_LAYOUT_VERSION = 27;
...
// ── Clock block ──────────────────────────────────────────────
export const CLOCK_COL_HALTED                    = 0; // u8
export const CLOCK_COL_HAS_RUN                   = 1; // u8
export const CLOCK_STRIDE                        = 2;

export function readClockHalted(view: DataView, row: number): number { return view.getUint8(row * CLOCK_STRIDE + CLOCK_COL_HALTED); }
export function readClockHasRun(view: DataView, row: number): number { return view.getUint8(row * CLOCK_STRIDE + CLOCK_COL_HAS_RUN); }
