...
export const NODE_DEFS: Record<string, NodeDef> = {
  ...
  Input: { bg: "#e0e0e0", border: "#666", text: "#1a1a1a", minWidth: 90, role: "input", shape: "rect", fill: "#e0e0e0", stroke: "#666", width: 80, height: 60, inputs: [{ name: "FeedbackIn", kind: "chain" }], outputs: [{ name: "ToChainInhibitor", kind: "chain" }, { name: "ToLatch", kind: "chain" }] },
  Latch: { bg: "#e8f5e9", border: "#1b5e20", text: "#1b5e20", minWidth: 36, role: "latch", shape: "rect", fill: "#e8f5e9", stroke: "#1b5e20", width: 36, height: 36, inputs: [{ name: "FromInput", kind: "chain" }], outputs: [{ name: "Out", kind: "chain" }] },
