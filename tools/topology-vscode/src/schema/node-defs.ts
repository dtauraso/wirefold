...
export const NODE_DEFS: Record<string, NodeDef> = {
  ...
  HoldNewSendOld: { bg: "#fff3e0", border: "#e65100", text: "#bf360c", minWidth: 90, role: "holdnewsendold", shape: "rect", fill: "#fff3e0", stroke: "#e65100", width: 90, height: 60, inputs: [{ name: "FromPrevHoldNewSendOldNode", kind: "chain" }], outputs: [{ name: "ToNext", kind: "chain", isMulti: true }, { name: "ToInput", kind: "chain" }] },
  Input: { bg: "#e0e0e0", border: "#666", text: "#1a1a1a", minWidth: 90, role: "input", shape: "rect", fill: "#e0e0e0", stroke: "#666", width: 80, height: 60, inputs: [{ name: "FeedbackIn", kind: "chain" }, { name: "FromHoldNewSendOld", kind: "chain" }], outputs: [{ name: "ToHoldNewSendOld", kind: "chain" }, { name: "ToExcitatory", kind: "chain" }, { name: "ToPacer", kind: "chain" }] },
...
export const NODE_DEFS_ARRAY: readonly NodeDef[] = [
  ...
  { bg: "#fff3e0", border: "#e65100", text: "#bf360c", minWidth: 90, role: "holdnewsendold", shape: "rect", fill: "#fff3e0", stroke: "#e65100", width: 90, height: 60, inputs: [{ name: "FromPrevHoldNewSendOldNode", kind: "chain" }], outputs: [{ name: "ToNext", kind: "chain", isMulti: true }, { name: "ToInput", kind: "chain" }] },
  { bg: "#e0e0e0", border: "#666", text: "#1a1a1a", minWidth: 90, role: "input", shape: "rect", fill: "#e0e0e0", stroke: "#666", width: 80, height: 60, inputs: [{ name: "FeedbackIn", kind: "chain" }, { name: "FromHoldNewSendOld", kind: "chain" }], outputs: [{ name: "ToHoldNewSendOld", kind: "chain" }, { name: "ToExcitatory", kind: "chain" }, { name: "ToPacer", kind: "chain" }] },
