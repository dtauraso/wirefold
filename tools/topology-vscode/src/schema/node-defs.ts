...
export const NODE_DEFS: Record<string, NodeDef> = {
  ...
  Input: { bg: "#e0e0e0", border: "#666", text: "#1a1a1a", minWidth: 90, role: "input", shape: "rect", fill: "#e0e0e0", stroke: "#666", width: 120, height: 120, inputs: [{ name: "FeedbackIn", kind: "chain" }], outputs: [{ name: "ToReadGate", kind: "chain" }] },
