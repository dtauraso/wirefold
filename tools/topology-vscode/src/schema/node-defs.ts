...
export const NODE_DEFS: Record<string, NodeDef> = {
  ...
  Excitatory: { bg: "#e8f5e9", border: "#1b5e20", text: "#1b5e20", minWidth: 36, role: "excitatory", shape: "rect", fill: "#e8f5e9", stroke: "#1b5e20", width: 36, height: 36, inputs: [{ name: "FromInput", kind: "chain" }], outputs: [{ name: "Out", kind: "chain" }] },
