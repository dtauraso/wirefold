...
Context: `main` is at `6b3094ed`. No task branch is active. Recent work is all merged and verified. New work is friction-driven (post-v0 posture) — pick from real editor use, no phase plan.
