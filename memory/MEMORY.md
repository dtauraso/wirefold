...
- [project_thesis_eliminate_work_not_throughput.md](project_thesis_eliminate_work_not_throughput.md) — Substrate optimizes for work eliminated by structure (shrink the denominator), not job throughput (numerator); reject throughput framings at the substance layer
