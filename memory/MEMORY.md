...
- [project_edge_midpoint_offset_plumbing.md](project_edge_midpoint_offset_plumbing.md) — `midpointOffset` is a schema-only stub (`wire-defs.ts`); no setter, no EdgeActionsCtx, no adapter threading exists in current code (verified 2026-05-26; prior "wired end-to-end" claim was wrong)
