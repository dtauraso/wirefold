...
- [project_lock_propagation_decentralized.md](project_lock_propagation_decentralized.md) — Lock propagation on move = decentralized node-to-node messages (no queue/collection); central worklist exploded and was reverted
