...
// Node is a sample-and-hold latch. It HOLDS one int value (the thing it is
...
// Latch self-emits -1 from the start (like the Input bootstrap), it is not
// inert until fed.
type Node struct {
	Fire         func()
	EmitGeometry func()
...
func init() {
	Wiring.Register("Latch", func() any { return &Node{} })
}
