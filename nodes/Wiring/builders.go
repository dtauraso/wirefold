...
func reflectBuild(ctx context.Context, name string, data *NodeData, pb PortBindings, e kindEntry, tr *T.Trace, geom nodeGeom) (Node, error) {
	...
	// func(left, right int)` field (WindowAndInhibitRightGate's two-sided held-input beads).
	...
	// times a coincidence window / fire dwell (WindowAndInhibitRightGate) freezes on pause and resumes
