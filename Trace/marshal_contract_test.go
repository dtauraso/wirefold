...
func TestMarshalEventMatchesFixture(t *testing.T) {
	events := []Event{
		...
		{Step: 4, Kind: KindPosition, Node: "A", Port: "out", Value: 1, hasValue: true, X: 1.5, Y: 2.5, Z: 0, hasPos: true, F: 0.5},
		...
		{Step: 8, Kind: KindArrive, Node: "A", Port: "out", Value: 1, hasValue: true},
		{Step: 9, Kind: KindFade, Edge: "AtoB", Faded: true},
	}
